...
public class Variables {
    ...
    public static void main(String[] args) {
        ...
        char myChar ='*';
        System.out.println("this is char1: " + myChar);

        char myNumericChar = 2389;
        System.out.println("this is char2: " + myNumericChar);

        char ch3 = '\u0054';
        System.out.println("this is char3: " + ch3);
