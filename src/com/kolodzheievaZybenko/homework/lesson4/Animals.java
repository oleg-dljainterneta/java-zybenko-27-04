...
public class Animals {
  ...
  public static void main(String[] args) {
    ...
    int foodDog = food(weight, day, perDay);
    System.out.println("Dog food per month: " + foodDog * dogs / 1000 + "Kg");

    int foodCat = food(weight, day, perDay);
    System.out.println("Cat food per month: " + foodCat * cats / 1000 + "Kg");

    int totalPrice = price(day, perDay, price, dogs, cats);
    System.out.println("Shelter maintenance cost " + totalPrice + "$");

  }

  public static int food(int weight, int day, int perDay) {
    return weight * day * perDay;
  }

  public static int price(int day, int perDay, int price, int dogs, int cats) {
